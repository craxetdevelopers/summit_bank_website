...
export default function Home() {
  const loanSection = {
    ...
    text: "Get up 100 Million instant business finance from Summit App at the best industry rate instant business finance from Summit App at the best industry rate.",
    button: false,
    buttontext: "",
