...
export default function DepositProduct() {
  ...
  const allSection = [
    {
      title: "Current Accounts (Qard Hasan)",
      text: "Our Qard Hasan Current Accounts are ideal for everyday transactions, offering you full access to your funds while ensuring zero interest. Your deposits are securely held and guaranteed by Summit Bank, allowing you to manage your finances with ease and integrity.",
      image: "/pages-section/current-account.png",
      reverse: true,

    },
    {
      title: "Savings Accounts (Mudarabah Savings)",
    ...
    {
      title: "Fixed/Term Deposits (Mudarabah Term Deposits)",
      text: "Choose our Mudarabah Term Deposits for structured, time-bound investments with competitive profit-sharing returns. It’s a reliable way to grow your wealth over time while aligning with your values.",
